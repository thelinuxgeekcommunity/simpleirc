...
public class ConversationActivity extends AppCompatActivity implements
  ...
  private void setupColors() {
      ...
      ab.setBackgroundDrawable(new ColorDrawable(_scheme.getToolbarBackground()));

      _mainToolbar.setBackgroundColor(_scheme.getToolbarBackground());

      // Create a SpannableString from the current server.
      SpannableString st = new SpannableString(server.getTitle());
      // Set the action bar elements color
      st.setSpan(new ForegroundColorSpan(_scheme.getToolbarText()),
